  ...
  return (
    <div className="relative inline-block text-left" ref={containerRef}>
      ...
      {isOpen && createPortal(
        ...
        >
          <div className="px-2 py-2 sticky top-0 z-10 border-b backdrop-blur-md" style={{ backgroundColor: theme.surface ? `${theme.surface}e0` : (theme.isDark ? 'rgba(31,41,55,0.9)' : 'rgba(255,255,255,0.9)'), borderColor: theme.borderFaint || (theme.isDark ? '#374151' : '#f3f4f6') }}>
